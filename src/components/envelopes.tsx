      ...
      <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 md:mt-24 lg:grid-cols-4">
        {openWhen.notes.map((note, i) => (
          ...
          >
            ...
            <span
              aria-hidden
              className="flex h-9 w-9 items-center justify-center rounded-full bg-wine-600 text-sm text-ivory-50 shadow-[inset_0_1px_0_rgb(244_237_231/0.25)]"
            >
              &#10038;
            </span>
            <span>
        ...
        {open !== null && (
          ...
          >
            ...
            <motion.div
              ...
              role="dialog"
              aria-modal="true"
              className="relative w-full max-w-lg rounded-2xl bg-ivory-50 p-9 shadow-[0_30px_100px_rgb(0_0_0/0.6)] md:p-12"
            >
              <button
                onClick={() => setOpen(null)}
              ...
              <p className="text-[10px] font-semibold tracking-[0.3em] text-wine-600 uppercase">Open when</p>
