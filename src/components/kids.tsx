  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-28 md:px-10 md:py-44">
      <div className="text-center">
        ...
        <h2 className="font-display mx-auto mt-6 max-w-3xl pb-2 text-4xl leading-[1.1] font-light tracking-tight md:text-6xl">
      ...
      <div className="mt-16 grid grid-cols-1 gap-10 sm:grid-cols-2 md:mt-24 md:grid-cols-3 md:gap-8">
        {kids.members.map((kid, i) => (
          ...
          >
            <div className="aspect-[5/6] overflow-hidden rounded-xl bg-ink-800">
